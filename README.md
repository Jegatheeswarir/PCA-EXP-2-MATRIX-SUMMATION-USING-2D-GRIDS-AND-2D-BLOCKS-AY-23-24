...
## OUTPUT:
<img width="1652" height="172" alt="image" src="https://github.com/user-attachments/assets/a5125909-a40e-4e45-826b-1e02e1cbe782" />


## RESULT:
The host took 0.850933 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.043392 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
